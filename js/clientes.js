function agregarCliente() {
    ...
    $.ajax({
        url: "https://g2afaec3cd4cbac-retosusa.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
        type: "POST",
        data: cliente,
        datatype: "JSON",
...
function actualizarClientes(id) {
    $.ajax({
        url: "https://g2afaec3cd4cbac-retosusa.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/"+id,
        data: {},
        type: "GET",
        datatype: "JSON",
