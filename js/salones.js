function agregarSalon() {
    ...
    $.ajax({
        url: "https://g2afaec3cd4cbac-retosusa.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/partyroom/partyroom",
        type: "POST",
        data: salon,
        datatype: "JSON",
...
function actualizarSalon(id) {
    $.ajax({
        url: "https://g2afaec3cd4cbac-retosusa.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/partyroom/partyroom/"+id,
        data: {},
        type: "GET",
        datatype: "JSON",
