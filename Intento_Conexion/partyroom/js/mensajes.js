function agregarMensaje() {
    ...
    $.ajax({
        url: "https://g2afaec3cd4cbac-retosusa.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message",
        type: "POST",
        data: mensaje,
        datatype: "JSON",
...
function  actualizarMensajes(id){
    $.ajax({
        url: "https://g2afaec3cd4cbac-retosusa.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message/"+id,
        data: {},
        type: "GET",
        datatype: "JSON",
